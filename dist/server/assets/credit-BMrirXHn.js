import { r as reactExports, W as jsxRuntimeExports } from "./server-BIdXp_LM.js";
import { m as createLucideIcon, i as useAuth, n as useChain, r as useTranslation, s as supabase, p as ClipboardList, x as ChevronRight, o as LoaderCircle, F as FileDown, v as Pencil, L as Label, I as Input, B as Button, X, w as Trash2, t as toast, y as drawHeader, z as LM, A as RM, D as CONTENT_BOTTOM, E as addFootersToAllPages, H as downloadPdf } from "./router-DBLSTV4T.js";
...
async function printBill(account, ownerName) {
  ...
  const {
    jsPDF
  } = await import("./jspdf.es.min-DuOIZdMi.js").then((n) => n.j);
  const doc = new jsPDF({
    unit: "mm",
    format: "a4"
  });
