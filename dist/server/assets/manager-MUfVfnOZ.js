import { W as jsxRuntimeExports, r as reactExports } from "./server-z-pMUGxH.js";
import { m as createLucideIcon, i as useAuth, n as useChain, r as useTranslation, s as supabase, R as Receipt, T as TriangleAlert, X, o as LoaderCircle, v as Pencil, w as Trash2, t as toast } from "./router-BPIw-ywf.js";
import { W as Wallet, T as TrendingDown } from "./wallet-Bgq6XBCe.js";
...
function ManagerExpenses({
  ...
  const [managerTab, setManagerTab] = reactExports.useState("sales");
  const [walletTxs, setWalletTxs] = reactExports.useState([]);
  const [loadingWallet, setLoadingWallet] = reactExports.useState(true);
  const loadWalletTxs = reactExports.useCallback(async () => {
    setLoadingWallet(true);
    const {
      data
    } = await sb.from("wallet_transactions").select("*").eq("profile_id", profile.id).order("created_at", {
      ascending: false
    }).limit(100);
    setWalletTxs(data ?? []);
...
${tag}`;
    try {
      const {
        error: rpcErr
      } = await supabase.rpc("add_manager_expense", {
...
${tag}`;
    try {
      ...
      if (diff > 0) {
        const {
          ...
          _expense_date: (/* @__PURE__ */ new Date()).toLocaleDateString("en-CA", {
            timeZone: "America/Port_of_Spain"
          })
        });
        if (rpcErr) {
        ...
        const {
          error: rpcErr
        } = await supabase.rpc("refund_manager_expense", {
          _manager_id: profile.id,
          _owner_id: ownerId,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-3 space-y-4 pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl px-5 py-4 flex items-center justify-between", style: {
      background: "var(--gradient-hero)",
      boxShadow: "var(--shadow-glow)"
    }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest", style: {
          color: "rgba(0,0,0,0.55)"
        }, children: "Wallet Balance" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-black mt-0.5", children: [
          "$",
          Number(profile.wallet_balance).toFixed(2)
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "h-8 w-8", style: {
        color: "rgba(0,0,0,0.25)"
      } })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setManagerTab("sales"), className: `flex items-center justify-center gap-2 py-3 text-sm font-black transition ${managerTab === "sales" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { className: "h-4 w-4" }),
        " Sales"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setManagerTab("expenses"), className: `flex items-center justify-center gap-2 py-3 text-sm font-black transition ${managerTab === "expenses" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"}`, children: [
    ...
    managerTab === "sales" ? (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-black text-xl", children: t("records", "Records") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-muted-foreground", children: [
            walletTxs.length,
            " records"
          ] })
        ] }),
        loadingWallet ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: Array.from({
          length: 4
        }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl h-16 bg-muted/30 animate-pulse" }, i)) }) : walletTxs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-sm py-8 text-center", children: "No records yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: walletTxs.map((tx) => {
