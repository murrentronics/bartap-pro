...
async function printBill(account, ownerName) {
  ...
  const {
    jsPDF
  } = await import("./jspdf.es.min-Bhc1heQl.js").then((n) => n.j);
  const doc = new jsPDF({
    unit: "mm",
    format: "a4"
  });
