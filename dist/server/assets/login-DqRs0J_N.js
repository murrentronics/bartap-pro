import { r as reactExports, W as jsxRuntimeExports, V as React2, a2 as React } from "./server-Cat304ed.js";
import { c as composeRefs, u as useComposedRefs, a as cn, b as useAuth, d as useNavigate, W as Wine, L as Label, I as Input, B as Button, e as usernameToEmail, s as supabase, t as toast, f as friendlyError, C as Capacitor } from "./router-BoLXNdSQ.js";
...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center px-3 py-8", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-black tracking-tight", children: "Bartendaz Pro" }),
    ...
    const tryReadClipboard = async () => {
      try {
        if (Capacitor.isNativePlatform()) {
          const {
            Clipboard
          } = await import("./index-mf0uEhk3.js");
          const {
            value: text
