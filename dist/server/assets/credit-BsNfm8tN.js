import { r as reactExports, W as jsxRuntimeExports } from "./server-C_mMGMSY.js";
import { g as createLucideIcon, b as useAuth, h as useChain, s as supabase, l as ChevronRight, i as LoaderCircle, P as Pencil, m as CircleCheck, L as Label, I as Input, B as Button, X, n as Trash2, D as DollarSign, t as toast, o as drawHeader, p as LM, R as RM, q as CONTENT_BOTTOM, r as addFootersToAllPages, v as downloadPdf } from "./router-CVI5s33s.js";
...
async function printBill(account, ownerName) {
  ...
  const {
    jsPDF
  } = await import("./jspdf.es.min-CtLIBA2a.js").then((n) => n.j);
  const doc = new jsPDF({
    unit: "mm",
    format: "a4"
  });
