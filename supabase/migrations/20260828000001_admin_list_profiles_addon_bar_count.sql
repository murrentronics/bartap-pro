-- Add addon_bar_count to admin_list_profiles so the admin badge shows
-- the real number of sub-bars (chain_bar_count can get stuck; addon_bar_count
-- is always re-counted from DB in create-addon-bars).
...
RETURNS TABLE (
  ...
  is_bar_account boolean, addon_bar_count integer
)
