  ...
  if (chainBars.length >= 10) {
    return (
      <div className="text-center py-20 space-y-4 px-6">
        ...
        <Button variant="outline" onClick={() => nav({ to: "/switch-bar" as "/" })}>
          Back to My Bars
        </Button>
      </div>
    );
  ...
  return (
    <div className="min-h-screen px-4 py-6 space-y-6">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Each bar is a fully independent account — its own items, wallet, cashiers, and records.
        </p>
      </div>
