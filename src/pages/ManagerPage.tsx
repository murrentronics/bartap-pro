...
function DashboardTab({
  ...
  profile: { id: string; username?: string | null; wallet_balance: number; role: string };
  ownerId: string;
  managerName: string;
  barIsOpen: boolean;
  ...
  const [walletSales, setWalletSales] = useState<{ id: string; amount: number; note: string; created_at: string; order_id?: string; order_items?: any; order_total?: number; order_paid?: number; order_change?: number; order_payment_method?: string; order_number?: number | null; cashier_id?: string | null }[]>([]);
  ...
  const loadOrders = useCallback(async () => {
    ...
    if (error) console.error("[ManagerPage] loadOrders error:", JSON.stringify(error));
